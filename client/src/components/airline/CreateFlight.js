...
import { selectDestinations, selectAirlineAirplanes } from "../../store/airline/selectors";
import { fetchAirlineDestinations, saveFlight } from "../../store/airline/actions";
...
export default function CreateFlight({ closeModal, airlineId }) {
    ...
    const [selectedDestinationValue, setSelectedDestinationValue] = React.useState({
    ...
    function handleChangeDestination(event) {
        ...
        updateNewFlightDetails(event);        
    }

    function updateNewFlightDetails(event){
    ...
    function renderSelectionDestinationData() {
        return airlines_destinations.map((airline_destination) => {
            return (
                <MenuItem value={airline_destination} key={airline_destination.destination.id}>{airline_destination.destination.city}</MenuItem>
            );
        })
    }

    function renderSelectionAirplaneData() {
        return airplanes.map((airplane) => {
            return (
                <MenuItem value={airplane} key={airplane.id}>{airplane.mark}</MenuItem>
            );
        })
    }
    ...
    return (
        ...
        >
            ...
            <FormControl className={classes.formControl}>
                ...
                <Select
                    value={selectedDestinationValue.airlineDestination}
                ...
                >
                    {renderSelectionDestinationData()}
                </Select>
            </FormControl>
            ...
            <FormControl className={classes.formControl}>
                ...
                <Select
                    value={selectedAirplaneValue.airplane}
