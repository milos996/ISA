        ...
        <div id="mainWrapper" className="main-wrapper">
            ...
            <Modal open={modalContent.isVisible}>
                <div className="modal-container">
                    {modalContent.value === MODAL_CONTENT.FRIENDS && <Friends userId={userId} />}
                    {modalContent.value === MODAL_CONTENT.SEARCH_USERS && <Search senderUserId={userId} />}
            ...
            <Container className="vertical-items left-align mr-t-120-l-80" classes={{
                root: classes.root
            }}>
            <h1>User profile</h1>
                <Container>
